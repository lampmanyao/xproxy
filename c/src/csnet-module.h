...
typedef int (*module_init_cb) (void* conntor, struct csnet_log* log, struct csnet_config* config);
...
void csnet_module_init(struct csnet_module*, void* conntor, struct csnet_log* log, struct csnet_config* config);
